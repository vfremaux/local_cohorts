...
$strcohorts = get_string('automatedcohortmembers', 'local_cohorts');

if ($category) {
    $PAGE->set_pagelayout('admin');
    $PAGE->set_context($context);
    $PAGE->set_url('/local/cohorts/list.php', array('id' => $cohortid, 'contextid' => $contextid));
...
if (!empty($members)) {
    ...
    echo $OUTPUT->notification(get_string('nousers', 'local_cohorts'));
}

echo $OUTPUT->single_button(new moodle_url('/cohort/index.php'), get_string('backtolist', 'local_cohorts'));
